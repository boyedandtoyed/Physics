...
export default defineConfig({
  ...
  projects: EDGE_URL ? [
    {
      name: 'edge',
      testMatch: /(shell|sim|deflection|interpretations|timeDilation|simStage|curvature|river|effectivePotential|mercuryPrecession|iscoExplorer|kerrShadow|frameDragging|penroseProcess)\.spec\.ts/,
